...
const ProposalSection = () => {
  return (
    <div className='flex flex-col items-center mx-8 md:mx-16 lg:mx-32' id={'proposal'}>
        ...
        <p className='font-light w-full lg:w-[704px] text-center leading-8'>Ahora que hemos llegado para ser tu socio estratégico, relájate y disfruta de la previa y tu evento <span className='text-mainColor font-semibold'>sin preocuparte por nada.</span></p>
    </div>
  )
}
