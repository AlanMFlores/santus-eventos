...
const Gallery = () => {
  return (
    <>
        ...
        <p className='w-full font-light leading-8 mb-16'>¡Muy pronto vas a poder ver las mejores imágenes de nuestros eventos! Mientras tanto te invitamos a ver, <Link href={'/'} className='text-mainColor'>nuestra propuesta y servicios</Link>.</p>
        </section>
