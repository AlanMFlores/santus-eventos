  ...
  return (
    <>
        ...
        <div className='flex flex-col gap-6 mb-16'>
            ...
            Nuestra productora de eventos es una empresa dedicada a la planificación, organización y ejecución de todo tipo de eventos. Nos especializamos en crear experiencias únicas y memorables, diseñadas a medida para satisfacer las necesidades y deseos de nuestros clientes.</p>
            <p className='font-light leading-8'>
            Nuestro equipo de profesionales altamente capacitados y apasionados por su trabajo se encarga de cada detalle, desde la conceptualización hasta la implementación, asegurando que cada evento sea un éxito rotundo. Trabajamos estrechamente con nuestros clientes para entender su visión, objetivos y presupuesto, y luego transformamos esas ideas en realidad.</p>
            <p className='font-light leading-8'>
            Ya sea que estemos organizando una conferencia empresarial, una gala benéfica, una boda de ensueño o un concierto multitudinario, nos esforzamos por brindar servicios de primera calidad. Coordinamos todos los aspectos logísticos, como la selección de lugares, la gestión de proveedores, la decoración, la iluminación, el sonido, el catering y mucho más. Nos aseguramos de que todo funcione sin problemas para que nuestros clientes y sus invitados disfruten al máximo del evento.</p>
            <p className='font-light leading-8'>
            Además de la planificación y ejecución, también ofrecemos servicios de asesoramiento y consultoría en eventos. Compartimos nuestra experiencia y conocimientos para ayudar a nuestros clientes a tomar decisiones informadas y estratégicas en cuanto a la temática, el formato y la promoción de sus eventos.</p>
            <p className='font-light leading-8'>
            En nuestra productora de eventos, nos enorgullece ofrecer un servicio personalizado, una atención meticulosa a los detalles y una pasión inquebrantable por crear experiencias inolvidables. Nuestro objetivo es superar las expectativas en cada evento y dejar una impresión duradera en todos los asistentes.</p>
        </div>
        ...
        <div className='flex flex-col items-center'>
            ...
            <div className='flex justify-center gap-20 mb-24'>
                <div>
                    ...
                    <p className='text-center'>Organizadora profesional de eventos</p>
                </div>
                <div>
